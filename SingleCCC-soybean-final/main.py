...
def main(testindex):
  ...
  for id in range(5):
    ...
    train_dataset = SoybeanDataset(train_data, train_label)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=0)
    test_dataset = SoybeanDataset(test_data, test_label)
    ...
    for epoch in range(1, 300):
      ...
      if (net.train_accurate == 1.0 and net.netLoss < 0.1):
          break
      if (net.netLoss < 0.05):
          break
