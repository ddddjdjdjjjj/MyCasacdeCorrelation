...
class MnistFeaturesTrainData(): #60000
    def __init__(self):
...
class MnistFeaturesTesData(): #10000  写Test被pycharm检测成测试模式
    def __init__(self):
...
class MnistFeaturesDataset(Dataset):
    ...
    def __init__(self, data, labels):  # 0 train 1 val 2 test
        super(MnistFeaturesDataset, self).__init__()
