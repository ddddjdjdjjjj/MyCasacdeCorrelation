...
train_datas = Cifar10FeaturesTrainData()
...
test_datas = Cifar10FeaturesTesData()
...
test_dataset = Cifar10FeaturesDataset(test_data, test_label)
test_loader = DataLoader(test_dataset, batch_size=5000, shuffle=True, num_workers=0)
