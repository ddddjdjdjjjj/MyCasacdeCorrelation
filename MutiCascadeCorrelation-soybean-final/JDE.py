...
class JDE():
    def __init__(self,maxgen=100,xs=[],es=[],dim=1):
       ...
       # self.dim = dim+1
        self.dim = dim
        self.LBOUND = np.full([1, self.dim], -10)
        self.UBOUND = np.full([1, self.dim], 10)
    ...
    def getBestd(self):
        ...
        bias = 1
        vs = self.fun1(np.array([self.bestx.dot(self.xs) + bias]))
...
class JDE5(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE5, self).__init__(maxgen, xs, es, dim)
    ...
    def calFitness(self, X):  #NP*DIM
        ...
        fitness=-1.0 *np.abs(corr[:,4])
        return fitness

class JDE6(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE6, self).__init__(maxgen, xs, es, dim)
    ...
    def calFitness(self, X):  #NP*DIM
        ...
        fitness=-1.0 *np.abs(corr[:,5])
        return fitness

class JDE7(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE7, self).__init__(maxgen, xs, es, dim)
    ...
    def calFitness(self, X):  #NP*DIM
        ...
        fitness=-1.0 *np.abs(corr[:,6])
        return fitness

class JDE8(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE8, self).__init__(maxgen, xs, es, dim)
    ...
    def calFitness(self, X):  #NP*DIM
        ...
        fitness=-1.0 *np.abs(corr[:,7])
        return fitness

class JDE9(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE9, self).__init__(maxgen, xs, es, dim)
    ...
    def calFitness(self, X):  #NP*DIM
        ...
        fitness=-1.0 *np.abs(corr[:,8])
        return fitness

class JDE10(JDE):
    def __init__(self, maxgen=100, xs=[], es=[], dim=1):
        super(JDE10, self).__init__(maxgen, xs, es, dim)
